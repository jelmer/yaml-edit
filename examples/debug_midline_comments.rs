...
fn main() {
    ...
    let test_cases = vec![
        (
            "flow_seq_comment_after_item",
            "array: [item1 # comment, item2]",
        ),
        (
            "flow_seq_comment_on_newline",
            "array: [item1, # comment\n  item2]",
        ),
        (
            "flow_map_comment_after_key",
            "obj: {key1 # comment: value1}",
        ),
        (
            "flow_map_comment_after_value",
            "obj: {key1: value1 # comment, key2: value2}",
        ),
        (
            "flow_map_comment_on_newline",
            "obj: {key1: value1, # comment\n  key2: value2}",
        ),
    ];
