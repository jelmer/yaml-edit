...
impl ErrorRecoveryContext {
    ...
    pub fn find_sync_point(&self, tokens: &[(SyntaxKind, String)], current: usize) -> usize {
        ...
        for (i, (kind, _)) in tokens[current..].iter().enumerate() {
...
mod tests {
    ...
    fn test_error_builder() {
        ...
        assert_eq!(
            error,
            "Syntax error. Expected: colon. Found: newline. Context: in mapping. Suggestion: add ':' after key"
        );
    }
